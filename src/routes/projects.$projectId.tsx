              ...
              <div key={milestone.id} className="flex items-start">
                <div className="flex flex-col items-center space-y-2 w-64">
                  ...
                  <div className="text-center space-y-1">
                    <div className="font-semibold text-sm">
                      {milestone.definition?.execution_number}. {milestone.definition?.name}
                    </div>
                    <div className="text-xs text-muted-foreground line-clamp-2" title={milestone.definition?.description}>
                ...
                {!isLast && (
                   <div className="flex items-center h-12 px-2">
                     <div className={cn("h-[2px] w-8", isCompleted && filteredMilestones[index+1]?.completed_at ? "bg-green-500" : "bg-gray-300")} />
                   </div>
                )}
              </div>
            );
