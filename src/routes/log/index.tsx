...
function Timeline() {
    ...
    const [milestonesChecked, setMilestonesChecked] = useState<boolean[]>([
        true, true, true, true, true, // M1–M5
        true, true, true, true, true, true, true, // M6–M11
        true, true, true, // M12–M14–M15
        false, false, false, false, false, // M16–M20
    ]);
    ...
    return (
        <div className="timeline-wrapper">
            <div className="timeline-inner">
                ...
                {/* QG1 box */}
                <div
                    className="qg-box qg-box-1"
                    onClick={() => toggleQGBox(0)}
                >
                    <div
                        className={
                            "milestone square " +
                            (qgBoxesChecked[0] ? "checked" : "")
                        }
                    >
                        {qgBoxesChecked[0] ? "✔" : ""}
                    </div>
                ...
                {/* QG2 box */}
                <div
                    className="qg-box qg-box-2"
                    onClick={() => toggleQGBox(1)}
                >
                    <div
                        className={
                            "milestone square " +
                            (qgBoxesChecked[1] ? "checked" : "")
                        }
                    >
                        {qgBoxesChecked[1] ? "✔" : ""}
                    </div>
                ...
                {/* QG3 box */}
                <div
                    className="qg-box qg-box-3"
                    onClick={() => toggleQGBox(2)}
                >
                    <div
                        className={
                            "milestone square " +
                            (qgBoxesChecked[2] ? "checked" : "")
                        }
                    >
                        {qgBoxesChecked[2] ? "✔" : ""}
                    </div>
                ...
                {/* QG4 box */}
                <div
                    className="qg-box qg-box-4"
                    onClick={() => toggleQGBox(3)}
                >
                    <div
                        className={
                            "milestone square " +
                            (qgBoxesChecked[3] ? "checked" : "")
                        }
                    >
                        {qgBoxesChecked[3] ? "✔" : ""}
                    </div>
                ...
                {/* QG5 box */}
                <div
                    className="qg-box qg-box-5"
                    onClick={() => toggleQGBox(4)}
                >
                    <div
                        className={
                            "milestone square " +
                            (qgBoxesChecked[4] ? "checked" : "")
                        }
                    >
                        {qgBoxesChecked[4] ? "✔" : ""}
                    </div>
